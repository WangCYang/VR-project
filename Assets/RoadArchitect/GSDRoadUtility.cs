...
//			if(bMainPlates){
//				Vector3[] tNormals = MF.sharedMesh.normals;
//				tNormals[0] = tNormals[4];
//				tNormals[1] = tNormals[4];
//				tNormals[tNormals.Length-1] = tNormals[tNormals.Length-3];
//				tNormals[tNormals.Length-2] = tNormals[tNormals.Length-4];
//				MF.sharedMesh.normals = tNormals;
//			}
...
//			xMesh.tangents = GSDRootUtil.ProcessTangents(xMesh.triangles,xMesh.normals,xMesh.uv,xMesh.vertices);
			MeshFilter MF = tObj.AddComponent<MeshFilter>();
			MF.sharedMesh = xMesh;
